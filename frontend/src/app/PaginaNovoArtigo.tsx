    ...
    <div className="min-h-screen bg-fundo">
      ...
      <ContainerPagina>
        <div className="flex items-center justify-between gap-4">
          <h1 className="font-serif text-2xl font-semibold text-slate-900">Novo artigo</h1>
          <BotaoVerde onClick={salvar}>Criar artigo</BotaoVerde>
        </div>
